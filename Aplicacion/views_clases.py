...
@login_required
def about(request):
    return render(request, "AplicacionTemplates/about.html")


# VISTAS BASADAS EN CLASES - CURSOS
class CursoListView(ListView):
    model = Curso
    template_name = "Templates/Vistas_Clases/curso_list.html"

class CursoDetailView(DetailView):
    model = Curso
    template_name = "Templates/curso_detalle.html"

class CursoCreateView( CreateView):
    model = Curso
    template_name = "Templates/curso_form.html"
    ...
    model = Curso
    template_name = "Aplicacion/curso_create.html"
    fields = ["nombre", "camada"]
